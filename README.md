...
[image7]: ./images/gazebo.png
[image8]: ./images/gazebo_rover.jpg
[image9]: ./images/gripper_collision.gif
[image10]: ./images/gym_bipedal.gif
[image11]: ./images/gym_bipedal.jpg
[image12]: ./images/LunarLander.png
[image13]: ./images/RL_discrete_continuous.png
[image14]: ./images/gazebo_arm.jpg

The aim of this project is to train reinforcement learning agents from virtual robotic simulation in 3D and transfer the agent to a real-world robot. Reinforcement learning agents are should choose the best action to perform based on environmental state (like camera inputs) and rewards that provide feedback to the agent about it's performance. Reinforcement learning can learn to behave optimally in it's environment given a policy, or task - like obtaining the reward.
...
$ git clone https://github.com/Mahmoud-Selim/RoboticsND-DeepRL-Project.git
...
## Results
The DQN was able to successfully complete both objectives. Both the objectives were achieved. For both of them, the accuracy was consistenly above 90% and increasing. Although the initial episodes had some impact on the initial accuracy, the agent could recover from it and achieved much higher accuracy than required (94% compared to 80%) and it was also increasing. 
